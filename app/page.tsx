...
export default function Page() {
  ...
  const handleShowStockPurchaseUI = async () => {
    try {
      ...
      const responseMessage = await show_stock_purchase_ui('Example content'); // Replace with actual content
      setMessages((currentMessages: any) => [...currentMessages, responseMessage]);
    } catch (error) {
      console.error(error);
    }
  ...
  const handleListStocks = async () => {
    try {
      ...
      const responseMessage = await list_stocks([]); // Pass actual stocks data
      setMessages((currentMessages: any) => [...currentMessages, responseMessage]);
    } catch (error) {
      console.error(error);
    }
